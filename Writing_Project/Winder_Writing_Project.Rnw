...
<<load_data, echo = F, warning = F, message = F, results = 'hide'>>=
library("readxl")
USBR.login <- read_excel("C:/Users/mwind/OneDrive/Writing-Project/USBR_2018_data_sample.xlsx", sheet = 1)
USBR.sampleprep <- read_excel("C:/Users/mwind/OneDrive/Writing-Project/USBR_2018_data_sample.xlsx", sheet = 2)
USBR.microscopy <- read_excel("C:/Users/mwind/OneDrive/Writing-Project/USBR_2018_data_sample.xlsx", sheet = 3)
USBR.PCR <- read_excel("C:/Users/mwind/OneDrive/Writing-Project/USBR_2018_data_sample.xlsx", sheet = 4)
