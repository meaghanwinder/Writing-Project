...
eDNA <- read.csv("C:/Users/mwind/OneDrive/Writing Project_EXTRA/eDNA.csv")
levels(eDNA$Lake)
@
...
<<sim1, echo = F, warning = F, message = F, results = 'hide'>>=
# SIMULATED DATA 1
set.seed(1202020)
...
<<echo = T, eval = F>>=
# put the code chunk names here like this: <<name>>
